...
//    typedef GlobPQ<UpdateRequest, HeapMultiQueue<Comparer, UpdateRequest, 1>> HMQ1;
    ...
    typedef AdaptiveMultiQueue<UpdateRequest, Comparer, 2, false, void, true, false, Prob <5, 1000>, Prob <1, 1000>, true> AMQ2CP_5_1000_1_1000;
    typedef AdaptiveMultiQueue<UpdateRequest, Comparer, 2, false, void, true, false, Prob <1, 1000>, Prob <1, 1000>, true> AMQ2CP_1_1000_1_1000;
    typedef AdaptiveMultiQueue<UpdateRequest, Comparer, 2, false, void, true, false, Prob <5, 1000>, Prob <5, 1000>, true> AMQ2CP_5_1000_5_1000;
    typedef AdaptiveMultiQueue<UpdateRequest, Comparer, 2, false, void, true, false, Prob <5, 1000>, Prob <1, 100>, true> AMQ2CP_5_1000_1_100;
...
//      Galois::for_each_local(initial, ProcessWithBreaks(this, graph), Galois::wl<HMQ1>());
    if (wl == "hmq2")
      ...
      Galois::for_each_local(initial, Process(this, graph), Galois::wl<AMQ2CP_5_1000_1_1000>());
    else if (wl == "amq2cp_0.001_0.001")
      Galois::for_each_local(initial, Process(this, graph), Galois::wl<AMQ2CP_1_1000_1_1000>());
    else if (wl == "amq2cp_0.005_0.005")
      Galois::for_each_local(initial, Process(this, graph), Galois::wl<AMQ2CP_5_1000_5_1000>());
    else if (wl == "amq2cp_0.005_0.01")
      Galois::for_each_local(initial, Process(this, graph), Galois::wl<AMQ2CP_5_1000_1_100>());
