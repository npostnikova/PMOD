...
private:
  ...
  static const size_t socketSize = 24;
  static const size_t LOCAL_W = 64;
...
public:
  ...
  struct rethread {
    typedef MultiQueueProbLocalNuma<T, Comparer, ChangeQPush, PopSize, C, Prior, _concurrent> type;
  };

  //! Change the type the worklist holds.
  template<typename _T>
  struct retype {
    typedef MultiQueueProbLocalNuma<_T, Comparer, ChangeQPush, PopSize, C, Prior, Concurrent> type;
  };
