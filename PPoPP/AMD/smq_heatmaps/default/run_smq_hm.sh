...
$MQ_ROOT/scripts/run_wl_n_times_all_threads.sh bfs usa smqhm_8_4 5 smqdef
$MQ_ROOT/scripts/run_wl_n_times_all_threads.sh bfs west smqhm_8_4 5 smqdef
$MQ_ROOT/scripts/run_wl_n_times_all_threads.sh bfs twi smqhm_8_4 5 smqdef
$MQ_ROOT/scripts/run_wl_n_times_all_threads.sh bfs web smqhm_8_4 5 smqdef
