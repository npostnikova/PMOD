...
CHUNK_SIZE=( 1 4 8 16 32 64 128 256 512 )
    ...
    for d in "${DELTAS[@]}"
      do
        ...
        do
          ...
          echo "if (wl == \"$obim_name\") WL_RUN($obim_name);" >> $1
        done
      done
  done
}
