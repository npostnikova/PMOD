...
def draw_hm_obim(image_filename, wl, path_prefix, threads, small_delta,
    ...
    if small_delta:
        draw_heatmap_obim( image_filename,  [
            ...
            [  f'{path_prefix}/baseline/sssp_twi_base_{threads}',
               f'{path_prefix}/baseline/sssp_web_base_{threads}',
               f'{path_prefix}/baseline/bfs_twi_base_{threads}',
               f'{path_prefix}/baseline/bfs_web_base_{threads}',
               f'{path_prefix}/baseline/bfs_usa_base_{threads}',
               f'{path_prefix}/baseline/bfs_west_base_{threads}',
               f'{path_prefix}/baseline/boruvka_usa_base_{threads}',
               f'{path_prefix}/baseline/boruvka_west_base_{threads}',
            ],
            [  'SSSP TWITTER',
               'SSSP WEB',
               'BFS TWITTER',
        ...
        draw_heatmap_obim(image_filename, [
           ...
           [
               f'{path_prefix}/baseline/sssp_usa_base_{threads}',
               f'{path_prefix}/baseline/sssp_west_base_{threads}',
               f'{path_prefix}/baseline/astar_usa_base_{threads}',
               f'{path_prefix}/baseline/astar_west_base_{threads}',
           ],
           [
               'SSSP USA',
               'SSSP WEST',
