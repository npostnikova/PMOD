...
#$MQ_ROOT/scripts/klsm_heatmaps.sh bfs run ctr $threads 64 5000000
$MQ_ROOT/scripts/klsm_heatmaps.sh bfs run usa $threads 64 5000000
$MQ_ROOT/scripts/klsm_heatmaps.sh bfs run west $threads 64 5000000
...
#$MQ_ROOT/scripts/klsm_heatmaps.sh sssp run ctr $threads 64 5000000
$MQ_ROOT/scripts/klsm_heatmaps.sh sssp run usa $threads 64 5000000
$MQ_ROOT/scripts/klsm_heatmaps.sh sssp run west $threads 64 5000000
...
$MQ_ROOT/scripts/klsm_heatmaps.sh astar run west $threads 64 5000000
$MQ_ROOT/scripts/klsm_heatmaps.sh astar run usa $threads 64 5000000
#$MQ_ROOT/scripts/klsm_heatmaps.sh astar run ctr $threads 64 5000000
